...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Food  Travel</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Food &amp; Travel' or . = 'Food &amp; Travel')]</locator>
