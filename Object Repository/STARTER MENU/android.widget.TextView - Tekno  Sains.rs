...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Tekno  Sains</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Tekno &amp; Sains' or . = 'Tekno &amp; Sains')]</locator>
