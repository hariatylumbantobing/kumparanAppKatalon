...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Pilih Kanal</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Pilih Kanal' or . = 'Pilih Kanal')]</locator>
