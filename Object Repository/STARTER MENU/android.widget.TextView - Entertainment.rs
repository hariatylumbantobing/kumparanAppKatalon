...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Entertainment</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Entertainment' or . = 'Entertainment')]</locator>
