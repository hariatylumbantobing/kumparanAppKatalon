...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - tulisan Atau gunakan</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Atau gunakan' or . = 'Atau gunakan')]</locator>
