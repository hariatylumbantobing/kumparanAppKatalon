...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - judul halaman Verifikasi</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Verifikasi' or . = 'Verifikasi')]</locator>
