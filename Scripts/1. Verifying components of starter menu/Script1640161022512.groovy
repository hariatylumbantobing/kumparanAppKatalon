...
Mobile.verifyElementExist(findTestObject('STARTER MENU/android.view.ViewGroup - garis pembatas 1'), 3)
...
Mobile.verifyElementExist(findTestObject('STARTER MENU/android.view.ViewGroup - garis pembatas 2'), 3)
...
Mobile.verifyElementExist(findTestObject('STARTER MENU/android.view.ViewGroup - garis pembatas 3'), 3)
...
Mobile.verifyElementExist(findTestObject('STARTER MENU/android.view.ViewGroup - garis pembatas 6'), 3)
...
Mobile.verifyElementExist(findTestObject('STARTER MENU/android.view.ViewGroup - garis pembatas 7'), 3)
...
Mobile.verifyElementExist(findTestObject('STARTER MENU/android.view.ViewGroup - garis pembatas 8'), 3)
...
Mobile.verifyElementExist(findTestObject('STARTER MENU/android.view.ViewGroup -garis pembatas 9'), 3)
...
Mobile.verifyElementExist(findTestObject('STARTER MENU/android.view.ViewGroup - garis pembatas 10'), 3)
...
Mobile.getAttribute(findTestObject('STARTER MENU/android.view.ViewGroup - button choose min 3 kanal'), 'checked', 5)

Mobile.delay(2)

Mobile.verifyElementAttributeValue(findTestObject('STARTER MENU/android.view.ViewGroup - button choose min 3 kanal'), 'checked', 
    'false', 10)
