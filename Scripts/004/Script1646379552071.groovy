...
Mobile.callTestCase(findTestCase('003'), [:], FailureHandling.STOP_ON_FAILURE)
Mobile.delay(2)
//Mobile.scrollToText('STARTER MENU/android.widget.TextView - Anda dapat mengatur ulang pilihan di halaman pengaturan notifikasi')
Mobile.tapAndHold(findTestObject('STARTER MENU/android.view.ViewGroup-selanjutnya button'), 3, 3)
Mobile.delay(2)
...
Mobile.waitForElementPresent(findTestObject('SWIPING PART/android.view.ViewGroup - tombol selanjutnya'), 3)
Swipe.swipe(SwipeDirection.RIGHT_TO_LEFT)
Mobile.waitForElementPresent(findTestObject('SWIPING PART/android.widget.ImageView-pic4'), 3)
Mobile.verifyElementExist(findTestObject('SWIPING PART/android.widget.TextView - text pic4'), 3)
Mobile.waitForElementPresent(findTestObject('SWIPING PART/android.view.ViewGroup - button Buat Akun'), 3)
Mobile.waitForElementPresent(findTestObject('SWIPING PART/android.view.ViewGroup - button Sudah Punya Akun'), 3)
